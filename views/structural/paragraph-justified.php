...
?><div class="style-item">
	<h3 class="item-title"><?php esc_html_e( 'Paragraph, justified', 'wp-style-guide' ); ?></h3>
	<p class="item-description"><?php

		esc_html_e( 'Blocks of text. Many times the p tags are added by WordPress automatically. This text should be justified.', 'wp-style-guide' );
